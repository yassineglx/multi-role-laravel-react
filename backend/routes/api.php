...
Route::group(['middleware' => ['auth:api', 'role:admin']], function () {
    ...
    Route::get('/products-with-categories', [ProductController::class, 'getProduct'])->name('products.with.categories');
    Route::resource('/gallery', GalleryController::class);

    // Category Routes
    Route::get('/categories', [CategoryController::class, 'getCategory'])->name('categories.index');
